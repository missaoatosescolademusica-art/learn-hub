      ...
      <section className="pt-32 pb-20 px-6">
        <div className="container mx-auto text-center max-w-4xl">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-foreground mb-6 animate-fade-in" style={{ animationDelay: '100ms' }}>
            ...
            <span className="text-gradient">vídeo aulas</span>{' '}
            gratuitas
          </h1>
          
          <p className="text-lg md:text-xl text-muted-foreground mb-10 max-w-2xl mx-auto animate-fade-in" style={{ animationDelay: '200ms' }}>
            Acesse centenas de aulas de alta qualidade, construa seu portfólio 
            e acelere sua carreira na tecnologia.
          </p>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div
                key={feature.title}
                className="p-8 rounded-2xl bg-card border border-border hover:border-primary/30 transition-all duration-300 animate-fade-in group"
          ...
          <div className="rounded-3xl gradient-primary p-1">
            <div className="rounded-[22px] bg-card p-12 text-center">
              ...
              <p className="text-lg text-muted-foreground mb-8 max-w-xl mx-auto">
                Junte-se a milhares de alunos que já estão aprendendo na nossa plataforma.
              </p>
              <Link to="/registro">
                <Button variant="hero" size="xl">
